    ...
    <div>
      ...
      <div className="container">
        ...
        <div className="tile is-parent is-vertical is-10" id="show-on-hover">
          ...
          <p className="content">
            Pass <code>showButtonsOnHover</code> prop if you want to display the
            action buttons only when the text hovered by the user.
          </p>
          <div className="columns">
            <div className="column is-half">
              <SyntaxHighlighter language="javascript" showLineNumbers={true}>
        ...
        >
          <div className="subtitle">
            <a href="#textarea-for-editing-input">Textarea for Editing Input</a>
          </div>
          <p className="content">
            You can use <code>{'<textarea>'}</code> for editing if your content
            is too long. Also you can specify custom class name and other props
            for the input element. Since this page has built with Bulma.io, we
            passed <code>textarea</code>
            as class name.
          </p>
          <div className="columns">
            <div className="column is-half">
        ...
        >
          ...
          <p className="content">
            By default, Action buttons have no titles. They are just some simple
            icons. But you can append <strong>any valid element</strong> next to
            those icons. See the example below.
          </p>
          <div className="columns">
            <div className="column is-half">
              <SyntaxHighlighter language="javascript" showLineNumbers={true}>
        ...
        >
          ...
          <p className="content">
            You may want locate action buttons before the input element instead
            of after it. Just pass the <code>buttonsAlign='before'</code> prop.
            You should be fine. Default value is already `after`. So don't pass
            anything if you don't want to change this.
          </p>
          <div className="columns">
            <div className="column is-half">
              <SyntaxHighlighter language="javascript" showLineNumbers={true}>
        ...
        <div className="tile is-parent is-vertical is-10" id="validation">
          ...
          <p className="content">
            ...
            validation message which will appear when validation fails. See the
            example. Delete some characters from content and try to save it.
          </p>
          <div className="columns">
            <div className="column is-half">
              <SyntaxHighlighter language="javascript" showLineNumbers={true}>
        ...
        >
          ...
          <p className="content">
            EdiText has a very basic validation handling. You will probably want
            to use an external library to show custom and fancy validation
            warnings or messages. You can track the validity of input value with
            <code>onValidationFail</code> prop. Just pass your method to listen
            and react against validation updates.
            <strong>
        ...
        <div className="tile is-parent is-vertical is-10" id="save-on-enter">
          ...
          <p className="content">
            ...
            <br />
            <strong>
              Be careful if you have multiple instances of <code>EdiText</code>
        ...
        <div className="tile is-parent is-vertical is-10" id="edit-on-focus">
          ...
          <div className="columns">
            ...
            <div className="column">
              <ol>
                <li>
                  Click into plain input then press <code>Tab</code> to focus to{' '}
                  <code>EdiText</code> input
                </li>
                <li>
      ...
      <footer className="footer" style={{ padding: 20 }}>
        <div className="content has-text-centered">
          <p>
            ...
            <a href="https://github.com/alioguzhan">Ali Oguzhan Yildiz</a>. The
